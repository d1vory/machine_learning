...
def build_grid(n, p_barrier, r_barrier, seed_nr):
    ...
    Args:
        ...
        r_barrier (int): reward for the barrier cells
    Returns:
        grid_world (Environment): grid world environment
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--barrier_probability", type=float, help='Probability of a cell being a barrier.')
    parser.add_argument(
        "--barrier_reward", type=float, help='Reward for the barrier cells.')
    parser.add_argument(
        "--value_func_intial", type=int, help='Initial value for the value function.')
    parser.add_argument(
    ...
    parser.add_argument(
        "--random_seed", type=int, help='Seed number, for reproducible results.')
